...
package Interfaces.STM32.FPU is
   ...
   subtype FPCCR_HFRDY_Field is Interfaces.STM32.Bit;
   subtype FPCCR_MMRDY_Field is Interfaces.STM32.Bit;
   subtype FPCCR_BFRDY_Field is Interfaces.STM32.Bit;
   subtype FPCCR_MONRDY_Field is Interfaces.STM32.Bit;
