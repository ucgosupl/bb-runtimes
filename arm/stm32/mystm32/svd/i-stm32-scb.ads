...
package Interfaces.STM32.SCB is
   ...
   subtype CPUID_Revision_Field is Interfaces.STM32.UInt4;
   subtype CPUID_PartNo_Field is Interfaces.STM32.UInt12;
   subtype CPUID_Constant_Field is Interfaces.STM32.UInt4;
   subtype CPUID_Variant_Field is Interfaces.STM32.UInt4;
   subtype CPUID_Implementer_Field is Interfaces.STM32.Byte;
   ...
   subtype ICSR_VECTACTIVE_Field is Interfaces.STM32.UInt9;
   subtype ICSR_RETTOBASE_Field is Interfaces.STM32.Bit;
   subtype ICSR_VECTPENDING_Field is Interfaces.STM32.UInt7;
   subtype ICSR_ISRPENDING_Field is Interfaces.STM32.Bit;
   subtype ICSR_PENDSTCLR_Field is Interfaces.STM32.Bit;
   subtype ICSR_PENDSTSET_Field is Interfaces.STM32.Bit;
   subtype ICSR_PENDSVCLR_Field is Interfaces.STM32.Bit;
   subtype ICSR_PENDSVSET_Field is Interfaces.STM32.Bit;
   subtype ICSR_NMIPENDSET_Field is Interfaces.STM32.Bit;
   ...
   subtype VTOR_TBLOFF_Field is Interfaces.STM32.UInt21;

   --  Vector table offset register
   type VTOR_Register is record
      --  unspecified
      Reserved_0_8   : Interfaces.STM32.UInt9 := 16#0#;
   ...
   subtype AIRCR_VECTRESET_Field is Interfaces.STM32.Bit;
   subtype AIRCR_VECTCLRACTIVE_Field is Interfaces.STM32.Bit;
   subtype AIRCR_SYSRESETREQ_Field is Interfaces.STM32.Bit;
   subtype AIRCR_PRIGROUP_Field is Interfaces.STM32.UInt3;
   subtype AIRCR_ENDIANESS_Field is Interfaces.STM32.Bit;
   subtype AIRCR_VECTKEYSTAT_Field is Interfaces.STM32.UInt16;
   ...
   subtype SCR_SLEEPONEXIT_Field is Interfaces.STM32.Bit;
   subtype SCR_SLEEPDEEP_Field is Interfaces.STM32.Bit;
   subtype SCR_SEVEONPEND_Field is Interfaces.STM32.Bit;
   ...
   subtype CCR_NONBASETHRDENA_Field is Interfaces.STM32.Bit;
   subtype CCR_USERSETMPEND_Field is Interfaces.STM32.Bit;
   subtype CCR_UNALIGN_TRP_Field is Interfaces.STM32.Bit;
   subtype CCR_DIV_0_TRP_Field is Interfaces.STM32.Bit;
   subtype CCR_BFHFNMIGN_Field is Interfaces.STM32.Bit;
   subtype CCR_STKALIGN_Field is Interfaces.STM32.Bit;
   ...
   subtype SHPR1_PRI_4_Field is Interfaces.STM32.Byte;
   subtype SHPR1_PRI_5_Field is Interfaces.STM32.Byte;
   subtype SHPR1_PRI_6_Field is Interfaces.STM32.Byte;
   ...
   subtype SHPR2_PRI_11_Field is Interfaces.STM32.Byte;

   --  System handler priority registers
   type SHPR2_Register is record
      --  unspecified
      Reserved_0_23 : Interfaces.STM32.UInt24 := 16#0#;
   ...
   subtype SHPR3_PRI_14_Field is Interfaces.STM32.Byte;
   subtype SHPR3_PRI_15_Field is Interfaces.STM32.Byte;
   ...
   subtype SHCRS_MEMFAULTACT_Field is Interfaces.STM32.Bit;
   subtype SHCRS_BUSFAULTACT_Field is Interfaces.STM32.Bit;
   subtype SHCRS_USGFAULTACT_Field is Interfaces.STM32.Bit;
   subtype SHCRS_SVCALLACT_Field is Interfaces.STM32.Bit;
   subtype SHCRS_MONITORACT_Field is Interfaces.STM32.Bit;
   subtype SHCRS_PENDSVACT_Field is Interfaces.STM32.Bit;
   subtype SHCRS_SYSTICKACT_Field is Interfaces.STM32.Bit;
   subtype SHCRS_USGFAULTPENDED_Field is Interfaces.STM32.Bit;
   subtype SHCRS_MEMFAULTPENDED_Field is Interfaces.STM32.Bit;
   subtype SHCRS_BUSFAULTPENDED_Field is Interfaces.STM32.Bit;
   subtype SHCRS_SVCALLPENDED_Field is Interfaces.STM32.Bit;
   subtype SHCRS_MEMFAULTENA_Field is Interfaces.STM32.Bit;
   subtype SHCRS_BUSFAULTENA_Field is Interfaces.STM32.Bit;
   subtype SHCRS_USGFAULTENA_Field is Interfaces.STM32.Bit;
   ...
   subtype CFSR_UFSR_BFSR_MMFSR_IACCVIOL_Field is Interfaces.STM32.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_MUNSTKERR_Field is Interfaces.STM32.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_MSTKERR_Field is Interfaces.STM32.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_MLSPERR_Field is Interfaces.STM32.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_MMARVALID_Field is Interfaces.STM32.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_IBUSERR_Field is Interfaces.STM32.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_PRECISERR_Field is Interfaces.STM32.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_IMPRECISERR_Field is Interfaces.STM32.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_UNSTKERR_Field is Interfaces.STM32.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_STKERR_Field is Interfaces.STM32.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_LSPERR_Field is Interfaces.STM32.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_BFARVALID_Field is Interfaces.STM32.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_UNDEFINSTR_Field is Interfaces.STM32.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_INVSTATE_Field is Interfaces.STM32.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_INVPC_Field is Interfaces.STM32.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_NOCP_Field is Interfaces.STM32.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_UNALIGNED_Field is Interfaces.STM32.Bit;
   subtype CFSR_UFSR_BFSR_MMFSR_DIVBYZERO_Field is Interfaces.STM32.Bit;
   ...
   subtype HFSR_VECTTBL_Field is Interfaces.STM32.Bit;
   subtype HFSR_FORCED_Field is Interfaces.STM32.Bit;
   subtype HFSR_DEBUG_VT_Field is Interfaces.STM32.Bit;
   ...
   type HFSR_Register is record
      ...
      --  unspecified
      Reserved_2_29 : Interfaces.STM32.UInt28 := 16#0#;
      --  Forced hard fault
   ...
   subtype ACTRL_DISMCYCINT_Field is Interfaces.STM32.Bit;
   subtype ACTRL_DISDEFWBUF_Field is Interfaces.STM32.Bit;
   subtype ACTRL_DISFOLD_Field is Interfaces.STM32.Bit;
   subtype ACTRL_DISFPCA_Field is Interfaces.STM32.Bit;
   subtype ACTRL_DISOOFP_Field is Interfaces.STM32.Bit;

   --  Auxiliary control register
   type ACTRL_Register is record
      --  DISMCYCINT
      DISMCYCINT     : ACTRL_DISMCYCINT_Field := 16#0#;
      --  DISDEFWBUF
      DISDEFWBUF     : ACTRL_DISDEFWBUF_Field := 16#0#;
      --  DISFOLD
      DISFOLD        : ACTRL_DISFOLD_Field := 16#0#;
      --  unspecified
      Reserved_3_7   : Interfaces.STM32.UInt5 := 16#0#;
      --  DISFPCA
      DISFPCA        : ACTRL_DISFPCA_Field := 16#0#;
      --  DISOOFP
      DISOOFP        : ACTRL_DISOOFP_Field := 16#0#;
      --  unspecified
      Reserved_10_31 : Interfaces.STM32.UInt22 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type SCB_Peripheral is record
      ...
      MMFAR                : aliased Interfaces.STM32.UInt32;
      --  Bus fault address register
      BFAR                 : aliased Interfaces.STM32.UInt32;
      --  Auxiliary fault status register
      AFSR                 : aliased Interfaces.STM32.UInt32;
   end record
     with Volatile;
