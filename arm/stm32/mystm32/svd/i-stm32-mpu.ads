...
package Interfaces.STM32.MPU is
   ...
   subtype MPU_TYPER_SEPARATE_Field is Interfaces.STM32.Bit;
   subtype MPU_TYPER_DREGION_Field is Interfaces.STM32.Byte;
   subtype MPU_TYPER_IREGION_Field is Interfaces.STM32.Byte;
   ...
   subtype MPU_CTRL_ENABLE_Field is Interfaces.STM32.Bit;
   subtype MPU_CTRL_HFNMIENA_Field is Interfaces.STM32.Bit;
   subtype MPU_CTRL_PRIVDEFENA_Field is Interfaces.STM32.Bit;
   ...
   subtype MPU_RNR_REGION_Field is Interfaces.STM32.Byte;
   ...
   subtype MPU_RBAR_REGION_Field is Interfaces.STM32.UInt4;
   subtype MPU_RBAR_VALID_Field is Interfaces.STM32.Bit;
   subtype MPU_RBAR_ADDR_Field is Interfaces.STM32.UInt27;
   ...
   subtype MPU_RASR_ENABLE_Field is Interfaces.STM32.Bit;
   subtype MPU_RASR_SIZE_Field is Interfaces.STM32.UInt5;
   subtype MPU_RASR_SRD_Field is Interfaces.STM32.Byte;
   subtype MPU_RASR_B_Field is Interfaces.STM32.Bit;
   subtype MPU_RASR_C_Field is Interfaces.STM32.Bit;
   subtype MPU_RASR_S_Field is Interfaces.STM32.Bit;
   subtype MPU_RASR_TEX_Field is Interfaces.STM32.UInt3;
   subtype MPU_RASR_AP_Field is Interfaces.STM32.UInt3;
   subtype MPU_RASR_XN_Field is Interfaces.STM32.Bit;
